...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#submit').on('click', function() {
            ...
            var tipe_suspensi = $("input[name=tipe_suspensi]").val();
            var tipe_transmisi = $("input[name=tipe_transmisi]").val();
            var kendaraan = $("#kendaraanData").val();


            if (mesin != "" && tipe_suspensi != "" && tipe_transmisi != "") {
                $.ajax({
                    url: "{{url('/api/motor')}}",
                    type: "POST",
                    data: {
